...
from rpn._generate_anchors import generate_anchors, generate_anchors_all_pyramids
from rpn._bbox_transform import clip_boxes, bbox_overlaps_batch, bbox_transform_batch
...
class _AnchorTargetLayer_FPN(nn.Module):
    ...
    def forward(self, input):
        ...
        keep = ((anchors[:, 0] >= -self._allowed_border) &
                ...
                (anchors[:, 2] < (im_info[1]) + self._allowed_border) &
                (anchors[:, 3] < (im_info[0]) + self._allowed_border))
